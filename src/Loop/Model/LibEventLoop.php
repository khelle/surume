...
namespace Surume\Loop\Model;

use Event;
use EventBase;
use SplObjectStorage;
use Surume\Loop\LoopModelInterface;
use Surume\Loop\Tick\ContinousTickQueue;
use Surume\Loop\Tick\FiniteTickQueue;
use Surume\Loop\Timer\Timer;
use Surume\Loop\Timer\TimerInterface;

/**
 * An ext-libevent based event-loop.
 */
class LibEventLoop implements LoopModelInterface
{
