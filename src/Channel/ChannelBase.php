...
use Surume\Channel\Request\RequestHelperTrait;
use Surume\Channel\Response\ResponseHelperTrait;
...
use Surume\Support\GeneratorSupport;
use Surume\Support\StringSupport;
use Surume\Support\TimeSupport;
use Surume\Throwable\LazyException;
use Surume\Throwable\Exception\System\TaskIncompleteException;
use Surume\Throwable\Exception;
...
class ChannelBase extends EventEmitter implements ChannelBaseInterface
{
    ...
    public function __construct($name, ChannelModelInterface $model, ChannelRouterCompositeInterface $router, ChannelEncoderInterface $encoder, LoopInterface $loop)
    {
        ...
        {
            throw new InstantiationException("Could not construct Surume\\Channel\\Channel due to Router wrong configuration.");
        }
    ...
    protected function handleReceiveResponse(ChannelProtocolInterface $protocol)
    {
        ...
        else if ($exception === 'Surume\Throwable\Exception\System\TaskIncompleteException')
        {
